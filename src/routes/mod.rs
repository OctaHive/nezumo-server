...
#[openapi(
    ...
    paths(
        ...
        handlers::post_users::request_current_user_email,
        handlers::post_users::verify_current_user_email,
        ...
        handlers::oauth::oauth_yandex,
        handlers::oauth::oauth_yandex_callback,
        handlers::oauth::oauth_vk,
        handlers::oauth::oauth_vk_callback,
