//! API-key database rows, request payloads, and public response schemas.
//!
//! Secret key material is returned only by creation and rotation responses;
//! persistent and listing models contain hashes or non-secret metadata.
