//! Batched API-usage persistence.
//!
//! Request middleware collects usage records in memory and periodically inserts
//! them through this module. The older single-row implementation remains below
//! as commented historical context.
